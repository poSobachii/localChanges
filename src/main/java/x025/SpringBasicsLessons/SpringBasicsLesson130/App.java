package x025.SpringBasicsLessons.SpringBasicsLesson130;

import org.springframework.context.ApplicationContext;
import org.springframework.context.ConfigurableApplicationContext;
import org.springframework.context.support.ClassPathXmlApplicationContext;
import x025.SpringBasicsLessons.SpringBasicsLesson130.beans.Client;
import x025.SpringBasicsLessons.SpringBasicsLesson130.beans.Event;
import x025.SpringBasicsLessons.SpringBasicsLesson130.beans.EventType;
import x025.SpringBasicsLessons.SpringBasicsLesson130.loggers.EventLogger;
...
public class App {
    ...
    public static void main(String[] args) {
        ConfigurableApplicationContext ctx = new ClassPathXmlApplicationContext(
                "spring130.xml", "loggers130.xml", "aspects130.xml", "db130.xml");

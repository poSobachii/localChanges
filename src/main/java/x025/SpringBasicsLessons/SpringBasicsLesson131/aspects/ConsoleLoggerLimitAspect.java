package x025.SpringBasicsLessons.SpringBasicsLesson131.aspects;
...
public class ConsoleLoggerLimitAspect {
    ...
    @Around("execution(* *.logEvent(x025.SpringBasicsLessons.SpringBasicsLesson131.beans.Event)) "
            + "&& within(x025.SpringBasicsLessons.SpringBasicsLesson131.loggers.ConsoleEventLogger) "
            + "&& args(evt)")
